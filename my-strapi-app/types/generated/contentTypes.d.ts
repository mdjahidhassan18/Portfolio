...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ChallengesFaced: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DateofFinish: Schema.Attribute.Date;
    FinishedImage: Schema.Attribute.Media<
    ...
    > &
      Schema.Attribute.Private;
    MethodologyWorkingPrinciple: Schema.Attribute.Text;
    ModelAndCircuitDiagram: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    Name: Schema.Attribute.String;
    Objective: Schema.Attribute.Text;
    ProgramCode: Schema.Attribute.RichText;
    ProjectBackgroundMotivation: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    ResultsOutcomeAchievements: Schema.Attribute.Text;
    ToolsAndTechnologiesUsed: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiPublicationPublication extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    coauthor: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    journalORconference: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
